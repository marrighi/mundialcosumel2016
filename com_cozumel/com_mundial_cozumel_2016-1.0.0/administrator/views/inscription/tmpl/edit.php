...
$document->addStyleSheet(JUri::root() . 'media/com_mundial_cozumel_2016/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_mundial_cozumel_2016&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="inscription-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_MUNDIAL_COZUMEL_2016_TITLE_INSCRIPTION', true)); ?>
		<div class="row-fluid">

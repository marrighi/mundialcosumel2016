...
$document->addStyleSheet(JUri::root() . 'media/com_mundial_cozumel_2016/css/list.css');

$user      = JFactory::getUser();
$userId    = $user->get('id');
$listOrder = $this->state->get('list.ordering');
$listDirn  = $this->state->get('list.direction');
$canOrder  = $user->authorise('core.edit.state', 'com_mundial_cozumel_2016');
$saveOrder = $listOrder == 'a.`ordering`';

if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_mundial_cozumel_2016&task=inscriptions.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_mundial_cozumel_2016&view=inscriptions'); ?>" method="post"
	...
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'inscriptions.', $canChange, 'cb'); ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_mundial_cozumel_2016&task=inscription.edit&id='.(int) $item->id); ?>">

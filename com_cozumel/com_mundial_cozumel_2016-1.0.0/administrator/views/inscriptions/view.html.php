...
/**
 * View class for a list of Mundial_cozumel_2016.
 *
 * @since  1.6
 */
class Mundial_cozumel_2016ViewInscriptions extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Mundial_cozumel_2016Helper::addSubmenu('inscriptions');
	...
	protected function addToolbar()
	{
		...
		$canDo = Mundial_cozumel_2016Helper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_MUNDIAL_COZUMEL_2016_TITLE_INSCRIPTIONS'), 'inscriptions.png');
		...
		{
			JToolBarHelper::preferences('com_mundial_cozumel_2016');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_mundial_cozumel_2016&view=inscriptions');
        ...
        $form = JForm::getInstance('com_mundial_cozumel_2016.inscription', 'inscription');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`last_name`' => JText::_('COM_MUNDIAL_COZUMEL_2016_INSCRIPTIONS_LAST_NAME'),
			'a.`name`' => JText::_('COM_MUNDIAL_COZUMEL_2016_INSCRIPTIONS_NAME'),
			'a.`gender`' => JText::_('COM_MUNDIAL_COZUMEL_2016_INSCRIPTIONS_GENDER'),
			'a.`birthdate`' => JText::_('COM_MUNDIAL_COZUMEL_2016_INSCRIPTIONS_BIRTHDATE'),
			'a.`event`' => JText::_('COM_MUNDIAL_COZUMEL_2016_INSCRIPTIONS_EVENT'),
			'a.`tshirt`' => JText::_('COM_MUNDIAL_COZUMEL_2016_INSCRIPTIONS_TSHIRT'),
			'a.`blood_type`' => JText::_('COM_MUNDIAL_COZUMEL_2016_INSCRIPTIONS_BLOOD_TYPE'),
			'a.`hotel`' => JText::_('COM_MUNDIAL_COZUMEL_2016_INSCRIPTIONS_HOTEL'),
		);
	}
}

...
$lang->load('com_mundial_cozumel_2016', JPATH_SITE);
$doc = JFactory::getDocument();
$doc->addScript(JUri::base() . '/media/com_mundial_cozumel_2016/js/form.js');
...
<div class="inscription-edit front-end-edit">
	...
	<form id="form-inscription"
		  action="<?php echo JRoute::_('index.php?option=com_mundial_cozumel_2016&task=inscription.save'); ?>"
	...
	<div class="control-group">
		...
		<div class="control-group">
			<div class="controls">
				...
				<?php endif; ?>
				<a class="btn"
				   href="<?php echo JRoute::_('index.php?option=com_mundial_cozumel_2016&task=inscriptionform.cancel'); ?>"
		...
		<input type="hidden" name="option" value="com_mundial_cozumel_2016"/>

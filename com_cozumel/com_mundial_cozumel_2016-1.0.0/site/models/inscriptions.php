...
if (empty($list['direction']))
{
		...
		protected function getListQuery()
	{
		...
		if (!JFactory::getUser()->authorise('core.edit', 'com_mundial_cozumel_2016'))
		{
...
$query->where('( a.last_name LIKE '.$search.'  OR  a.name LIKE '.$search.'  OR  a.email LIKE '.$search.'  OR  a.hotel LIKE '.$search.' )');
			}
		}
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_MUNDIAL_COZUMEL_2016_SEARCH_FILTER_DATE_FORMAT"), "warning");

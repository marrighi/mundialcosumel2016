 ...
 * @since  1.6
 */
class Mundial_cozumel_2016ControllerInscription extends Mundial_cozumel_2016Controller
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Inscription', 'Mundial_cozumel_2016Model');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_mundial_cozumel_2016') || $user->authorise('core.edit.state', 'com_mundial_cozumel_2016'))
		{
			$model = $this->getModel('Inscription', 'Mundial_cozumel_2016Model');
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_mundial_cozumel_2016&view=inscriptions', false));
			}
			else
			{
	...
	public function remove()
	{
		...
		if ($user->authorise('core.delete', 'com_mundial_cozumel_2016'))
		{
			$model = $this->getModel('Inscription', 'Mundial_cozumel_2016Model');

 ...
 * @since  1.6
 */
class Mundial_cosumel_2016ModelInscriptionForm extends JModelForm
{
	private $item = null;
	...
	public function &getData($id = null)
	{
		if ($this->item === null)
		{
			...
			if ($table !== false && $table->load($id))
			{
				...
				$id   = $table->id;
				$canEdit = $user->authorise('core.edit', 'com_mundial_cosumel_2016') || $user->authorise('core.create', 'com_mundial_cosumel_2016');

				if (!$canEdit && $user->authorise('core.edit.own', 'com_mundial_cosumel_2016'))
				{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_mundial_cosumel_2016.inscription', 'inscriptionform', array(
			'control'   => 'jform',
			'load_data' => $loadData
			)
		);
	...
	{
		$data = JFactory::getApplication()->getUserState('com_mundial_cosumel_2016.edit.inscription.data', array());
	...
	public function save($data)
	{
		...
		if ($id)
		{
			...
			$authorised = $user->authorise('core.edit', 'com_mundial_cosumel_2016') || $authorised = $user->authorise('core.edit.own', 'com_mundial_cosumel_2016');
		}
		else
		{
			// Check the user can create new items in this section
			$authorised = $user->authorise('core.create', 'com_mundial_cosumel_2016');
		}
	...
	public function delete($data)
	{
		...
		if (JFactory::getUser()->authorise('core.delete', 'com_mundial_cosumel_2016') !== true)
		{

...
/**
 * inscription Table class
 *
 * @since  1.6
 */
class Mundial_cosumel_2016Tableinscription extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__mc2016_inscripcion', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		// Support for multiple or not foreign key field: event
			if(!empty($array['event']))
			{
				...
				else if(strrpos($array['event'], ',') != false){
		...
		// Support for multiple or not foreign key field: tshirt
			if(!empty($array['tshirt']))
			{
				...
				else if(strrpos($array['tshirt'], ',') != false){
		...
		// Support for multiple or not foreign key field: blood_type
			if(!empty($array['blood_type']))
			{
				...
				else if(strrpos($array['blood_type'], ',') != false){
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_mundial_cosumel_2016.inscription.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_mundial_cosumel_2016/access.xml',
				"/access/section[@name='inscription']/"
			);
			$default_actions = JAccess::getAssetRules('com_mundial_cosumel_2016.inscription.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_mundial_cosumel_2016.inscription.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_mundial_cosumel_2016');

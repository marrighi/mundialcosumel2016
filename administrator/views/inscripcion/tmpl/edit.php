...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="inscripcion-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_MUNDIAL_COSUMEL_2016_TITLE_INSCRIPCION', true)); ?>
		<div class="row-fluid">

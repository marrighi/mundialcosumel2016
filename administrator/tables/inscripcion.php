...
/**
 * inscripcion Table class
 *
 * @since  1.6
 */
class Mundial_cosumel_2016Tableinscripcion extends JTable
{
	/**
	 * Constructor
	 *
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_mundial_cosumel_2016.inscripcion.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_mundial_cosumel_2016/access.xml',
				"/access/section[@name='inscripcion']/"
			);
			$default_actions = JAccess::getAssetRules('com_mundial_cosumel_2016.inscripcion.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_mundial_cosumel_2016.inscripcion.' . (int) $this->$k;
	}
